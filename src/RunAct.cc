...
{
    fstream fout1("/mnt/hgfs/VMplayer/Halp/Source.txt", ios::out);
    for (auto it1: *result1)
        fout1 << it1.first << " " << it1.second << '\n';
    fout1.close();

    fstream fout2("/mnt/hgfs/VMplayer/Halp/Detector_No_1.txt", ios::out);
    for (auto it2: *result2)
        fout2 << it2.first << " " << it2.second << '\n';
    fout2.close();

    fstream fout3("/mnt/hgfs/VMplayer/Halp/Detector_No_2.txt", ios::out);
